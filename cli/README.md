...
> **Local maintenance version:** `v0.2.4-local.1` adds the knowledge-ingestion Skill and its verified URL/body normalization asset. The latest upstream npm release remains `v0.2.3`; this local prerelease must be published explicitly before npm installation can provide the new Skill.
