...
> **LLM Wiki release:** `v0.4.1-wiki.1` adds project-source registration, bounded A/B/C manifests, host-binding diagnostics, and controlled path resolution without reading arbitrary project-file content.
