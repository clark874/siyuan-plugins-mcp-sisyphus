...
> **LLM Wiki release:** `v0.4.0-wiki.1` adds `doctor`, Node.js 20+ startup validation, strict unknown-flag rejection, canonical JSON sidecars, complete write-protocol help, and AV semantic readback.
