...
```text
https://github.com/clark874/siyuan-plugins-mcp-sisyphus/releases/download/v0.7.5-local.16/siyuan-agent-kit.zip
```
...
```text
https://github.com/clark874/siyuan-plugins-mcp-sisyphus/releases/tag/v0.7.5-local.16
```

后续交给其他本地 Agent 时，优先提供本文件的固定版本地址：

```text
https://raw.githubusercontent.com/clark874/siyuan-plugins-mcp-sisyphus/v0.7.5-local.16/agent-kit/START-HERE.md
```
