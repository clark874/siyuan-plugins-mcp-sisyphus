...
- `block`: insert, prepend, append, update, replace, delete, move, set_fold_state, get_kramdown, get_children, transfer_references, set_attrs, get_attrs, info, breadcrumb, dom, recent_updated, word_count, add_to_daily_note, docs_info
