...
│  - Tool Registry (12 aggregated tools)                      │
...
1. **Aggregated tool surface**: 12 MCP tools (fs / notebook / document / block / av / file / search / tag / system / flashcard / mascot / feedback), rather than 100+ single-purpose tools.
