...
export const SEARCH_ACTION_HINTS: Partial<Record<SearchAction, string>> = {
    ...
    check_anchor: 'Checks exact normalized name/alias tokens before knowledge compilation. name candidates must be globally unique; alias collisions are reported for semantic or custom-anchor-scope adjudication rather than rejected automatically.',
