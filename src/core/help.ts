...
export const FILE_ACTION_HINTS: Partial<Record<FileAction, string>> = {
    ...
    extract_doc: 'Use a document ID + optional outputDir. Exports the document markdown and all referenced assets into an uncompressed folder, preserving original filenames. The returned extractedDir is an absolute path ready for direct file access.',
};
