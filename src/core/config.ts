...
export const FILE_ACTIONS = ['upload_asset', 'render', 'export_md', 'export_md_zip', 'export_resources', 'list_unused_assets', 'get_doc_assets', 'get_image_ocr_text', 'remove_unused_assets', 'rename_asset', 'delete_asset'] as const;
...
export function buildDefaultToolConfig(): ToolConfig {
    return {
        ...
        file: {
            enabled: true,
            actions: createActionsRecord(FILE_ACTIONS, ['upload_asset', 'render', 'export_md', 'export_md_zip', 'export_resources', 'list_unused_assets', 'get_doc_assets', 'get_image_ocr_text', 'remove_unused_assets', 'rename_asset', 'delete_asset']),
