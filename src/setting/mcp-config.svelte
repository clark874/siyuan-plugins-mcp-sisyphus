    ...
    const GROUP_DEFINITIONS: GroupDefinition[] = [
        ...
        },
        {
            ...
            actions: [
                ...
                { key: "get_doc_assets", title: "Get Document Assets", description: "List all assets referenced by a document." },
                { key: "get_doc_image_assets", title: "Get Document Image Assets", description: "List image assets referenced by a document." },
