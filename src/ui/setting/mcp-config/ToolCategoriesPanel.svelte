    ...
    const ACTION_METADATA: GroupDefinition[] = [
        ...
        },
        {
            ...
            actions: [
                ...
                { key: "export_md_zip", title: "Export Markdown ZIP", description: "Export a document with SiYuan's official Markdown ZIP flow, including embed-block assets." },
                ...
                { key: "get_doc_assets", title: "Get Direct Document Assets", description: "List assets directly referenced by the current document tree. Use Markdown ZIP export for complete export resources." },
