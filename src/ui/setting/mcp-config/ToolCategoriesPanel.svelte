    ...
    const GROUP_DEFINITIONS: GroupDefinition[] = [
        ...
        },
        {
            ...
            actions: [
                ...
                { key: "resolve", title: "Resolve Document Reference", description: "Resolve document IDs, storage paths, human-readable paths, and metadata." },
                ...
                { key: "set_cover", title: "Set/Clear Document Cover", description: "Set or clear the document cover image." },
        ...
        },
        {
            ...
            actions: [
                ...
                { key: "render_attribute_view", title: "Render Database View", description: "Render database rows with optional view, pagination, and query context." },
        ...
        },
        {
            ...
            actions: [
                ...
                { key: "set_image_alpha", title: "Set Image Alpha", description: "Set image alpha for an asset." },
            ],
        },
        {
            category: "search",
