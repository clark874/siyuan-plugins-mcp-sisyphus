...
export const AV_VARIANTS: ActionVariant<AvAction>[] = [
    ...
    createZodActionVariant('render', AvRenderSchema, 'Render an attribute view with optional paging/filtering; with createIfNotExist=true, materialize a SiYuan-style AV block under blockID.'),
