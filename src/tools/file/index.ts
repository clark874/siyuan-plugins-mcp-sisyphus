...
export const FILE_VARIANTS: ActionVariant<FileAction>[] = [
    ...
    createZodActionVariant('export_md_zip', FileExportMdZipSchema, 'Export document as the official Markdown ZIP archive.'),
    ...
    createZodActionVariant('get_doc_assets', FileGetDocAssetsSchema, 'List assets directly referenced by the current document tree. Use export_md_zip for complete Markdown export resources.'),
