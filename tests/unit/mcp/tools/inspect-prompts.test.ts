...
import { buildDefaultToolConfig, type ToolCategory } from '@/mcp/config';
import {
    AV_TOOL_NAME,
    AV_VARIANTS,
    listAvTools,
...
import {
    ...
    FLASHCARD_VARIANTS,
    listFlashcardTools,
} from '@/mcp/tools/flashcard';
import {
    MASCOT_TOOL_NAME,
    MASCOT_VARIANTS,
    listMascotTools,
} from '@/mcp/tools/mascot';
import {
    NOTEBOOK_TOOL_NAME,
    NOTEBOOK_VARIANTS,
    listNotebookTools,
} from '@/mcp/tools/notebook';
import {
    SEARCH_TOOL_NAME,
    SEARCH_VARIANTS,
    listSearchTools,
...
import {
    ...
    SYSTEM_VARIANTS,
    listSystemTools,
} from '@/mcp/tools/system';
import {
    TAG_TOOL_NAME,
    TAG_VARIANTS,
    listTagTools,
} from '@/mcp/tools/tag';
import { tryHandleHelpAction, type ActionVariant } from '@/mcp/tools/shared';
