...
describe('portable agent kit', () => {
    ...
    it('contains a parseable secret-free MCP template and accurate Kimi instructions', () => {
        ...
        expect(delivery).toEqual(expect.objectContaining({
            distribution: {
                startHere: expect.stringContaining('/v0.8.6-wiki.1/agent-kit/START-HERE.md'),
                archive: expect.stringContaining('/v0.8.6-wiki.1/siyuan-agent-kit.zip'),
        ...
        expect(releaseChannel).toEqual(expect.objectContaining({
            schemaVersion: 1,
            channel: 'stable',
            version: '0.8.6-wiki.1',
            package: expect.objectContaining({
                url: expect.stringContaining('/v0.8.6-wiki.1/package.zip'),
                sha256: expect.stringMatching(/^[a-f0-9]{64}$/),
            }),
            agentKit: expect.objectContaining({
                url: expect.stringContaining('/v0.8.6-wiki.1/siyuan-agent-kit.zip'),
                sha256: expect.stringMatching(/^[a-f0-9]{64}$/),
            }),
        }));
