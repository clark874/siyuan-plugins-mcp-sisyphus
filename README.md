...
> **Latest:** `v0.2.7` — Added complete API mapping documentation, enhanced tool coverage for block/document/file/search/av, and introduced normalize module for better parameter handling. See full history in [CHANGELOG.md](./CHANGELOG.md).
