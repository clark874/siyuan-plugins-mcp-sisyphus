...
> **Latest:** `v0.2.11` — CLI tool `siyuan-sisyphus` preview release on npm; all 10 aggregated tools and 115+ actions are now callable from the terminal. See full history in [CHANGELOG.md](./CHANGELOG.md).
