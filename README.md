...
> **Latest:** `v0.4.13` — Adds explicit MCP HTTP bind address selection, tightens settings UI behavior, and improves error-code analytics and file icons. CLI remains `v0.1.15`.
